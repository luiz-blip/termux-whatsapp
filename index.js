...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=5544997346216:+55 4499734-6216\n' // WhatsApp ID + phone number
            + 'END:VCARD'
/******END OF VCARD INPUT******/
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["5544997346216@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '5544997346216@s.whatsapp.net'
                        /******ApiKey Input******/
	    ...
	    case 'kapankah':
            ...
            break
				...
				case 'simi':
					...
					teks = body.slice(5)
					anu = await simih(teks) //fetchJson(`https://mhankbarbars.herokuapp.com/api/samisami')
					reply(anu)
					break
				case 'simih':
					if (!isGroup) return reply(mess.only.group)
